...
// para l´a
void desiste(int t, struct heroi_ent *h, struct base_ent *b, struct fprio_t *f);
...
void sai(int t, struct heroi_ent *h, struct base_ent *b, struct fprio_t *f);

// O her´oi H se desloca para uma base D (que pode ser a mesma onde j´a esta)
void viaja(int t, struct heroi_ent *h, struct base_ent *b, struct fprio_t *f);
